...
class Colleges(models.Model):
    ...
    year_of_affiliation = models.CharField(max_length=4,null=True)
    location = models.CharField(max_length=1)
    lat = models.CharField(max_length=20)
    lng = models.CharField(max_length=20)
    college_type = models.CharField(max_length=20,null=True)
    is_autonomous = models.BooleanField(default=False)
    has_diploma_courses = models.BooleanField(default=False)
    management = models.CharField(max_length=30,db_index=True)
